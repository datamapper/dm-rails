...
Once you have bundler installed, you can bootstrap a rails3 application with a single command. Yes! A single command. Behold!

  rails dm_rails3_app -m http://is.gd/7V3Xq
